    ...
    <View style={{flex: 1}}>
      <ScrollView showsVerticalScrollIndicator={false} style={styles.main}>
        ...
        <View style={styles.footer}>
          <View>
            {total !== 0 ? (
              <Text style={styles.totalText}>Total : IDR {total}</Text>
            ) : (
              <Text style={styles.totalText}>Total : Your cart is empty</Text>
            )}
          </View>
          <TouchableOpacity style={styles.button} onPress={() => total !== 0 ? navigation.navigate('Checkout') : {}}>
            <IconCart />
            <Text
              style={{
